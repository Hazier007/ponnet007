...
const windowBenefits = [
  {
    ...
    description: 'Specialist in alle type ramen'
  },
  {
    icon: Tool,
...
const windowServices = [
  {
    icon: Lock,
    title: 'Raam Noodopening',
    description: 'Specialist in het openen van vastgelopen ramen',
    features: [
      'Slot defect',
      'Hendel gebroken',
      'Vergrendeling vast',
  ...
  {
    icon: Window,
    title: 'Raam Reparatie',
    description: 'Vakkundige reparatie van raamsloten en mechanismen',
    features: [
      'Sluitmechanisme',
      'Raambeslag',
      'Scharnieren',
  ...
  },
  {
    ...
    description: 'Voorkomen van toekomstige problemen',
    features: [
      'Mechanisme controle',
      'Slijtage inspectie',
      'Smering service',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <section className="relative bg-blue-900 text-white pt-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">Professionele Raam Opening</h1>
            <p className="text-xl mb-8">Specialist in het openen van alle soorten ramen</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Waarom Kiezen voor Onze Raam Service?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Onze Raam Diensten</h2>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Raam Problemen?</h2>
