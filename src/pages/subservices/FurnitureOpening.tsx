...
const furnitureBenefits = [
  {
    ...
    description: 'Specialist in alle type meubelsloten'
  },
  {
    icon: Tool,
...
const furnitureServices = [
  ...
  {
    icon: Sofa,
    title: 'Antiek Meubels',
    description: 'Vakkundige opening van antieke meubels',
    features: [
      'Voorzichtige aanpak',
  ...
  },
  {
    ...
    description: 'Professionele reparatie van meubelsloten',
    features: [
      'Mechanisme herstel',
      'Slot vervanging',
...
export function FurnitureOpening() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <section className="relative bg-blue-900 text-white pt-24">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?auto=format&fit=crop&q=80')] opacity-20 bg-cover bg-center" />
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">Professionele Meubelopening</h1>
            <p className="text-xl mb-8">Specialist in het openen van alle soorten vergrendelde meubels</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Waarom Kiezen voor Onze Meubelopening Service?</h2>
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-8">
            {furnitureBenefits.map((benefit) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Onze Meubelopening Diensten</h2>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Meubel Problemen?</h2>
